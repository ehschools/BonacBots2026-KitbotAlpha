...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    autoChooser.addOption("Blue One", Autos.blueOne(driveSubsystem, ballSubsystem));
    autoChooser.addOption("Blue Two", Autos.blueTwo(driveSubsystem, ballSubsystem));
    autoChooser.addOption("Blue Three", Autos.blueThree(driveSubsystem, ballSubsystem));
    autoChooser.addOption("Red One", Autos.redOne(driveSubsystem, ballSubsystem));
    autoChooser.addOption("Red Two", Autos.redTwo(driveSubsystem, ballSubsystem));
    autoChooser.addOption("Red Three", Autos.redThree(driveSubsystem, ballSubsystem));
  }
  ...
  private void configureBindings() {
    ...
    // * changed so it's on the driver controller
